        ...
        const handleClick = (e) => {
            if (categoriasSelecionadas.includes(categoria._id)) {
                ...
                setCategoriasSelecionadas([
                    ...categoriasSelecionadas.filter((e) => e != categoria._id),
                ]);
            } else {
                //Agregamos
                setCategoriasSelecionadas([
    ...
    return (
        <section className="filtrosContenedorPrincipal">
            ...
            <div className="categoriasContainer">
                {categorias.length > 0 ? (
                    ...
                    <p className="titulo-descripcion text-danger">
                        Ninguna categoria registrada en el sistema aun...
                    </p>
                )}
            </div>
            ...
            <div className="costoContainer">
                <InputNumber
                    size="large"
                    className="precioFiltro"
                    onChange={(e) => handleChangeCosto(e, "min")}
                    defaultValue={0}
                    prefix="$"
                />
                <InputNumber
                    size="large"
                    className="precioFiltro"
                    onChange={(e) => handleChangeCosto(e, "max")}
                    defaultValue={99999}
                    prefix="$"
                />
            </div>
