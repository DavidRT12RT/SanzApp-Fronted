...
export const RegistrarProductoNew = () => {
    ...
    const steps = [
        {
            ...
            content: (
                <div className="d-flex align-items-start flex-column">
                    ...
                    <label for="cantidad" className="form-label mt-3">
                        Cantidad del producto en bodega:{" "}
                    </label>
                    <input
                        type="number"
                        className="form-control"
                        ...
                        required
                    />
                    <label for="estado" className="form-label mt-3">
                        Estado del producto:{" "}
                    </label>
                    <select
                        id="estado"
                    ...
                    <label for="costo" className="form-label mt-3">
                        Costo del producto:{" "}
                    </label>
                    <input
                        type="number"
                        ...
                        required
                    />
                    <label for="inventariable" className="form-label mt-3">
                        Inventariable:{" "}
                    </label>
                    <select
                        type="number"
                        ...
                        className="form-select"
                        aria-describedby="inventariableHelpBlock"
                        value={formValues.inventariable}
                        name={"inventariable"}
                        onChange={handleInputChange}
                    >
                    ...
                    <div id="inventariableHelpBlock" class="form-text">
                        Marcar que el producto sea inventariable o NO tendra un
                        impacto a la hora de realizar reportes de inventario, ya
                        que solo podras contabilizar los productos marcados como
                        inventariables
                    </div>
                </div>
            ),
        },
        {
            ...
            content: (
                <div className="d-flex align-items-start flex-column">
                    <label for="unidad" className="form-label mt-3">
                        Unidad:{" "}
                    </label>
                    <select
                        id="unidad"
                    ...
                    <select
                        ...
                        defaultValue={
                            categorias.length > 0 && categorias[0]._id
                        }
                        className="form-select"
                        value={formValues.categoria}
                        name="categoria"
                        onChange={handleInputChange}
                        placeholder="Categoria a la que pertenece este producto."
                        size="large"
                    >
                    ...
                    <label for="descripcion" className="form-label mt-3">
                    ...
                    <textarea
                        ...
                        rows="4"
                    ></textarea>
                    <label for="aplicaciones" className="form-label mt-3">
    ...
    const onFinish = async () => {
        ...
        confirm({
            ...
            content:
                "El producto sera registrado dentro del almacen y podra ser usado para salidas a obras y resguardos.",
            okText: "Registrar",
    ...
    if (finish.estado) {
        return (
            <Result
                ...
                extra={[
                    <Link to={`/almacen/productos/${finish.producto._id}`}>
                    ...
                    <Button
                        onClick={() => {
                            setFinish({ estado: false, producto: null });
                        }}
                    >
        ...
        return (
            <div className="padre">
                <div className="container hijo p-3 p-lg-5">
                    <h1 className="nombre-producto text-center">
                        Registrar un nuevo producto
                    </h1>
                    <h1 className="descripcion-producto text-center mb-5">
                        Llenar los siguientes datos para registrar un nuevo
                        producto a almacen.
                    </h1>
