    ...
    if(informacionEntrada === null){
        ...
        return (
            <div className="container p-5" style={{minHeight:"100vh"}}>
                ...
                <h1 className="titulo" style={{fontSize:"42px"}}>Entrada del almacen</h1>
                <div className="row">
                    <div className="col-12 col-lg-6">
                        <Divider/>
                        <div className="row">
                            <h1 className="titulo" style={{fontSize:"32px"}}>Informacion de la entrada</h1>
                            <h1 className="titulo-descripcion col-6">Tipo de la entrada: </h1>
                            <h1 className="col-6 descripcion">{informacionEntrada.tipo.toUpperCase()}</h1>
                            <h1 className="titulo-descripcion col-6">dinero TOTAL de la entrada: </h1>
                            <h1 className="col-6 descripcion text-success">${informacionEntrada.costoTotal}</h1>
                            <h1 className="titulo-descripcion col-6">Fecha creacion: </h1>
                            <h1 className="col-6 descripcion">{informacionEntrada.fecha}</h1>
                            {

                                (informacionEntrada.tipo == "sobrante-obra" || informacionEntrada.tipo == "devolucion-resguardo") &&
                                <>
                                    <h1 className="titulo-descripcion col-6">Entrada a la salida: </h1>
                                    <Link to={`/almacen/salidas/${informacionEntrada.salida}`} target="_blank"><h1 className="col-6 descripcion text-primary">{informacionEntrada.salida}</h1></Link>
                                </>
                            }
                       </div>
                    </div>
                    <div className="col-12 col-lg-6">
                        ...
                        <div className='row'>
                            <h1 className="titulo-descripcion text-danger">Para las entradas el beneficiario es el sistema.</h1>
                        </div>
                    </div>
                </div>
                <Divider/>
                <h1 className="titulo">Lista de productos devueltos</h1>
                <Table columns={columnsProductosDevueltos} dataSource={informacionEntrada.listaProductos}/>
