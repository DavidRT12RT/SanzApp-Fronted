        ...
        <div className="empresaCard" onClick={handleClick}>
            <div className="contentLeft">
                ...
                <div className="empresaInformation">
                    <h1 className="titulo-descripcion">{empresa.nombre} <span className="ms-3"><Tag color={empresa.estado ? "green" : "red"}>{empresa.estado ? "Activa" : "Desactiva"}</Tag></span></h1>
                    <span className="text-warning"><hr/></span>
                    <p className="descripcion">Sucursales {empresa.sucursales.length} Obras {empresa.obras.length}</p>
                </div>
            </div>
