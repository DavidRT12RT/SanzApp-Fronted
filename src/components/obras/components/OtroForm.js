import { Form, Row,Col,Input, Tag, Select, InputNumber, Space } from 'antd'
import React from 'react'
import { Link } from 'react-router-dom';

export const OtroForm = () => {
  ...
  return (
      ...
      <Form form={form} layout="vertical" autoComplete="off" onFinish={onFinish} className="mt-3">
          <Row gutter={16}>
              ...
              <Col span={12}>
                <Form.Item 
                  ...
                  label="Titulo de la obra / servicio"
                  rules={[
                  {
                    required:true,
                ...
                >
                  <Input placeholder="Obra monte de piedad , servicio a sucursal de ..."/>
                </Form.Item>
              </Col>
            ...
            <Col span={12}>
              ...
              <Col span={12}>
                <Form.Item 
                    ...
                    label="Plaza de la obra o servicio"
                    rules={[
                      {
                        required:true,
          ...
          <Col span={12}>
              <Form.Item
                  name="estadoReporte"
                  label="Estado del reporte (por defecto nuevo)"
