import { Button, Card, Col, DatePicker, Divider, Row, Statistic } from 'antd';
...
export const GastosResumen = ({obraInfo,socket}) => {
    ...
    return (
        <>
            ...
            <Divider/>
            <div className="statistics" style={{margin:"40px 0px 40px 0px"}} ref={graficaRef}>
