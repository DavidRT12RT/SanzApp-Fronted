...
export const GastosComprobables = ({obraInfo,socket}) => {
    ...
    useEffect(() => {
        obraInfo.gastos.comprobables.registros.map(element => element.key = element._id);
    ...
    const handleSearch = (value) =>{
        ...
        const resultadosBusqueda = obraInfo.gastos.comprobables.registros.filter(elemento => {
    ...
    const handleUpload = async () =>{
        ...
        let body;
        try {
            const resp = await fetchConTokenSinJSON(`/uploads/obras/obra/${obraId}/gastos/comprobables`,formData,"POST");
    ...
    return (
           <div>
                ...
                <p className="lead">En esta sección se encontraran todas las facturas COMPROBABLES de la obra junto a su
                ...
                <Row gutter={16} className="mt-3">
                    <Col xs={24} md={8}>
                        <Card>
                            <Statistic
                                title="Total de gastos comprobables"
                    ...
                    <Col xs={24} md={8} className="mt-3 mt-md-0">
                        <Card>
                            <Statistic
                                title="Numero de registros comprobables"
                ...
                <Modal title="Agregar factura" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} footer={null}>
                        <h1>Subir un nuevo gasto COMPROBABLE a la obra</h1>
